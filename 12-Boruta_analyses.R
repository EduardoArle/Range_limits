...
s_minT_relPol_EQ$bodyMass_log <- log(s_minT_relPol_EQ$bodyMass)
s_minT_relPol_POL$bodyMass_log <- log(s_minT_relPol_POL$bodyMass)
...
s_meanT_relPol_EQ$bodyMass_log <- log(s_meanT_relPol_EQ$bodyMass)
s_meanT_relPol_POL$bodyMass_log <- log(s_meanT_relPol_POL$bodyMass)
...
s_maxT_relPol_EQ$bodyMass_log <- log(s_maxT_relPol_EQ$bodyMass)
s_maxT_relPol_POL$bodyMass_log <- log(s_maxT_relPol_POL$bodyMass)
...
#define predictor names as they appear in Boruta output files
pred_internal <- c('rangeSize_log10',
                   'latAmplitude',
                   'rangeLoc',
                   'elevMedian',
                   'elevAmplitude',
...
#define predictor names as they should appear in final table
pred_labels <- c('Range size',
