...
minT_distEdge_GS_k5_k4 <- gam(Min_T_SHAP ~
                                      s(distEdge, k=5, m=2) 
...
summary(minT_distEdge_GS_k5_k4)
logLik(minT_distEdge_GS_k5_k4)

setwd(wd_models)
saveRDS(minT_distEdge_GS_k5_k4, 'minT_distEdge_GS_k5_k4')


plot.gam(minT_distEdge_GS_k5_k4, select = 1, residuals = F, shade = T,
