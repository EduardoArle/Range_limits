##### THIS SCRIP WILL BE INCORPORATED IN NEW 3 (NUMBER_Prepare_mammal...)
...
########################################################
# use this for now, work on automated selection soon ###
...
for(i in 1:length(sps_list))
{
  ...
  sps_occ_coord <-
    sps_occ_coord[complete.cases(sps_occ_coord$decimalLatitude),] 
