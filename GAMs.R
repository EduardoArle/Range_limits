...
minT_relPolewarness_G_k10 <- gam(Min_T_SHAP ~
                               s(relPolewardness, k=10, bs="tp") 
                             + s(species, k=503, bs="re"),
                             data = results,
                             method="REML",
                             family="gaussian")
...
summary(minT_relPolewarness_G_k10)
logLik(minT_relPolewarness_G)
...
plot.gam(minT_relPolewarness_G, select = 2, residuals = F, 
         cex.lab = 2, cex.axis = 1.5)  #save 800
...
plot.gam(minT_relPolewarness_GS, select = 2, residuals = F, 
         cex.lab = 2, cex.axis = 1.5)  #save 800
...
setwd(wd_models)
saveRDS(minT_relPolewarness_S, 'minT_relPolewarness_S')

draw(minT_relPolewarness_S, page = 1)

plot.gam(minT_relPolewarness_S, select = 1, residuals = F, shade = T,
         cex.lab = 2, cex.axis = 1.5) #save 800
...
plot.gam(meanT_relPolewarness_G, select = 2, residuals = F, 
         cex.lab = 2, cex.axis = 1.5)  #save 800
...
logLik(meanT_relPolewarness_GS)
...
#model G
maxT_absPolewarness_G <- gam(Max_T_SHAP ~
                               s(absPolewardness, k=4, bs="tp") 
                             + s(species, k=503, bs="re"),
                             data = results,
                             method="REML",
...
draw(maxT_absPolewarness_G, page = 1)
...
#model GS
maxT_absPolewarness_GS <- gam(Max_T_SHAP ~
                                s(absPolewardness, k=4, m=2) 
                              + s(absPolewardness, species, k=4, bs="fs", m=2),
                              data = results,
                              method="REML")
