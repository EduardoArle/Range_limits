...
plot(st_geometry(points_sf),
     add = T, pch = 19, cex = points_sf$centralCex ^ 1.3,
     col = '#964B0080')
...
abline(lin_mod_minT, col = '#964B00', lwd = 7)
...
#plot the occurrence points (size is proportional to SHAP value)
plot(st_geometry(points_sf),
     add = T, pch = 19, cex = points_sf$varContNormal ^ 1.7,
     col = '#964B0080')
...
#Legend: Change in stationarity of extreme variables closer to range edges.

#Reference in text: "The explanatory power of extreme environmental measurements increase towards species’ poleward edges (Fig. 1C)"
...
#plot the occurrence points for minT (size is proportional to SHAP value)
plot(st_geometry(points_sf),
     add = T, pch = 19, cex = points_sf$varContNormal ^ 1.7,
     col = '#0000FF80')
...
#plot the occurrence points for minT (size is proportional to SHAP value)
plot(st_geometry(points_sf),
     add = T, pch = 19, cex = rev(points_sf$varContNormal) ^ 1.7,
     col = '#FF000080')
